...
const About = () => {
  ...
  return (
    <section className="c-space section-spacing " id="about">
      <h2 className="text-heading text-[#e6e8ee] ">About Me</h2>
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1 ">
          ...
          />
          <div className="z-10">
            <p className="headtext ">Hi, I'm Saad Ansari</p>
            <p className="subtext">
              A fresher in fullstack but ready for any challenges
            </p>
          </div>
        ...
        <div className="grid-default-color grid-2">
          ...
          >
            ...
            <Card
              style={{ rotate: "75deg", top: "30%", left: "20%", ring: "ring-gray-700" }}
              text="GRASP"
        ...
        <div className="grid-default-color grid-5">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              ...
              allow me to build modern and scalable applications
            </p>
          </div>
